...
import com.library.fileimagepicker.models.sort.SortingTypes
import java.util.*
...
class FilePickerBuilder {
    ...
    private fun start(context: Activity, requestCode: Int) {
        ...
        PickerManager.providerAuthorities = context.applicationContext.packageName + ".filepicker.provider"
    ...
    private fun start(fragment: androidx.fragment.app.Fragment, requestCode: Int) {
        fragment.context?.let {
            ...
            PickerManager.providerAuthorities = it.applicationContext?.packageName + ".filepicker.provider"
