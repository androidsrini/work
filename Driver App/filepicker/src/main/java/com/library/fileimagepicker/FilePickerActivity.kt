...
import com.library.fileimagepicker.filepicker.fragments.DocFragment
import com.library.fileimagepicker.filepicker.fragments.DocPickerFragment
import com.library.fileimagepicker.filepicker.fragments.MediaPickerFragment
import com.library.fileimagepicker.filepicker.fragments.PhotoPickerFragmentListener
import com.library.fileimagepicker.filepicker.utils.FragmentUtil
import java.util.*
...
class FilePickerActivity : BaseFilePickerActivity(), PhotoPickerFragmentListener, DocFragment.DocFragmentListener, DocPickerFragment.DocPickerFragmentListener, MediaPickerFragment.MediaPickerFragmentListener {
    ...
    override fun onItemSelected() {
        ...
        /*if (PickerManager.isMultiSelectEnable) {
            val currentCount = PickerManager.currentCount
